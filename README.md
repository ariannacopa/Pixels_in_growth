...
1. Vista Calendario: una griglia di quadrati disposti in ordine cronologico e raggruppati in settimane e mesi, con etichette che indicano i mesi e gli anni principali. È possibile approfondire il codice esadecimale dle colore medio e la quantità di foto scattate.
...
2. La vista Calendario ha un layout a righe e colonne. I quadrati si colorano in base alla media cromatica delle foto: bianco per i giorni senza scatti, colorati per i giorni in cui hi fotografato.
